...
- Prepare a thorough **Set Plan**. It's recommended to start with our [template](https://docs.google.com/spreadsheets/d/1h-nj4PNht7EYa6FqX1l7MnsaYOUo44jiiFFdb9zK6Wk/edit?gid=758167871#gid=758167871), but you may adjust one to fit your needs over time.
